...
<div  className="main-content-section">
        ...
        <div className="col-sm-12 row-table-event ">
                    
                       
                    <table className="table listing-table">
         <thead className="light-head">
           <tr>
             <th  className="col-2 width-12">Name </th>
             <th  className="col-4 width-10">Post</th>
             <th  className="col-6 width-15">Skill set</th>
             
             <th  className="col-2 width-8">Exp</th>
             <th  className="col-4 width-8">CTC</th>
             <th  className="col-6 width-8">EXP CTC</th>
             <th  className="col-2 width-8">Notice period</th>
             <th  className="col-4 width-10">Location</th>
             <th  className="col-6 width-8">Status</th>
                       <th  className="col-6 width-8">Action</th>
               </tr>
         </thead>
         <tbody>
           <tr>
             <td className="col-2 width-12">Anil Kumar</td>
             <td className="col-4 width-10">Java developer</td>
             <td className="col-2 width-15">HTML, CSS, JavaScript, Figma...</td>
             <td className="col-4 width-8">10 Years</td>
             <td className="col-2 width-8">5 LK/A</td>
             <td className="col-4 width-8">6 LK/A</td>
             <td className="col-2 width-8">2 Month</td>
             <td className="col-4 width-10">Kakkanad</td>
             <td className="col-2 width-8"><span className="status-nprogress">Inprogress</span></td>
                       <td className="col-6 width-8"> </td>
             </tr>  
