...
const { handleChange1, values, handleSubmit, errors } = useForm(validate);
  return (
    ...
    <div id="app">
      <div className="tab-module m-t-25">
        <div className="tab-module__tablist" role="tablist">
          <button  className="tab-module__tab Candidatedetails-tab" role="tab" aria-selected="true" aria-controls="colors-tab" id="colors" >
            Basic Information
          </button>
          ...
          <button className="tab-module__tab Candidatedetails-tab" role="tab" aria-selected="false" aria-controls="styles-tab" id="styles" tabindex="-1" >
            Schedule Details
          </button>
          ...
          <button className="tab-module__tab Candidatedetails-tab" role="tab" aria-selected="false" aria-controls="hardware-tab" id="hardware" tabindex="-1" >
            Rejection Reasons
          </button>
