...
<img src={Offboarding3} />
      ...
      <Table className="recruitment-tabele">
        ...
        <TableRow>
            ...
            <TableCell className="width-18">Mail ID </TableCell>
        ...
        {this.state.employeelist.map(n => {
            return (
              <TableRow  key={n.empid} >
                    ...
                    <TableCell numeric className="width-12">{n.emp_code}</TableCell>                          
                    ...
                    <div className="edit-new-icon ">
                          <Resignationicons id= {n.empid} name={n.emp_name} code = {n.emp_code}/>
                          </div>
             <div className="edit-new-icon ">
