    ...
    return (
      ...
      <Table className="recruitment-tabele">
        ...
        {data.map(n => {
            return (
              <TableRow  key={n.id} >
                    <TableCell  className="width-18"> {n.Name}</TableCell>
                    <TableCell numeric className="width-18">{n.EmployeeCode}</TableCell>                          
                    <TableCell numeric className=" width-12">{n.Designation} </TableCell>
                    <TableCell numeric className=" width-15">{n.MailID} </TableCell>
                    <TableCell numeric className="width-18">{n.Experience}</TableCell>
