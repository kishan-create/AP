...
function Row(props) {
  ...
  const edit = async (id) => {
    ...
    const reponse = await axios.get(
      `http://auditportal.bourntec.com:3001/audit_portal/public/api/editfecthdepdata/${department_id}`
    );
    // setIsOpen(true);
    if (reponse.data.status == 200) {
      SetValues({
  ...
  const editDesignation = async (id) =>{
    ...
    const reponse = await axios.get(
      `http://auditportal.bourntec.com:3001/audit_portal/public/api/editfecthdesdata/${designation_id}`
    );
  ...
  const updateDepartment = async (e) => {
    ...
    const res = await axios.put(
      "http://auditportal.bourntec.com:3001/audit_portal/public/api/update_department",
      values
    );
  ...
  const updateDesignation = async (e) => {
    ...
    e.preventDefault();
    const res = await axios.put(
      "http://auditportal.bourntec.com:3001/audit_portal/public/api/update_designation",
      editValues
    );
    if (res.data.status == 200) {
      swal({
  ...
  const deleteDepartment = async (e, id) => {
    ...
    const res = await axios.delete(
      `http://auditportal.bourntec.com:3001/audit_portal/public/api/delete_departments/${id}`
    );
    // if (res.data.status == 200) {
