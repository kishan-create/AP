...
export default function BasicTabs({ setColumns, skill }) {
  ...
  const { handleChange1, values, handleSubmit, errors, getpostName, job, handleImage, onSelect, selectedOption, onSelectPrimarySkill, onSelectSecondaryskill } = useForm(validate, setColumns);
  const options = [
