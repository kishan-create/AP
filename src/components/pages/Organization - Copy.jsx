...
export default class Organization extends Component {
  ...
  async edit(id) {
    ...
    const reponse = await axios.get(
      `http://auditportal2.bourntec.com:3001/audit_portal/public/api/editfecthorgdata/${org_id}`
    );
  ...
  deleteOrganization = async (e, id) => {
    ...
    const res = await axios.delete(
      `http://auditportal2.bourntec.com:3001/audit_portal/public/api/delete_organization/${id}`
    );
                      ...
                      {this.state.organization.map((n) => {
                        return (
                          <TableRow key={n.id}>
                            ...
                            <TableCell numeric className="width-18">
                              {n.org_name}
                            </TableCell>
                            <TableCell numeric className=" width-18">
                              {n.org_category}{" "}
                            </TableCell>
                            <TableCell numeric className=" width-20">
                              {n.org_type}{" "}
                            </TableCell>
                            <TableCell numeric className="width-18">
                              {n.org_location}
                              ...
                              <div className="action-outer">
                                ...
                                <div className="delete-icon">
                                  <svg
                                    width="7"
                                    onClick={(e) =>
                                      this.deleteOrganization(e, n.id)
                                    }
                                    height="10"
                                    viewBox="0 0 7 10"
                                    fill="none"
                    ...
                    <AccordionItemHeading className="accordion-active-status">
                      <AccordionItemButton>
                        <div className="accordion-head-text">
                          <div className="name notificatio-outer">Encaps</div>
