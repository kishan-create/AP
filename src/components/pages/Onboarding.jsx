...
export default class OfferReleasereport extends Component {
  ...
  async getDetails() {
    const res = await axios.get(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/getcandidates_release_details"
    );
  ...
  async ViewEmployeeStatus(id) {
    const response = await axios.get(
      `http://auditportal2.bourntec.com:3001/audit_portal/public/api/editfetchCandidatestatusdata/${id}`
    );
  ...
  async editLog(id) {
    const reponse = await axios.get(
      `http://auditportal2.bourntec.com:3001/audit_portal/public/api/editfetchCandidatefulldata/${id}`
    );
  ...
  addEmpolyeeFirst = async (e) => {
    e.preventDefault();
    const res = await axios.post(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/Addemployee",
      this.state.formData
    );
    if (res.data.status == 200) {
      alert("data updated successfully");
                  ...
                  <Table className="recruitment-tabele">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell className="width-20 offer-map-width ">
                          Action
                        </TableCell>
                      </TableRow>
                    </TableHead>
                          ...
                          <TableRow key={n.id}>
                            ...
                            >
                              <div className="emp-map-iocn-outer">
                                ...
                                <div className="emp-edit-new-icon ">
                                  <img
                                    onClick={() => this.editLog(n.id)}
                                    src={PencilNew}
                                  />
                                </div>
                                <div className="emp-defer-icon ">
                                  <img
                                    onClick={() => this.Viewlog(n.id)}
                                    src={DeferTime}
                                  />
                                </div>
                              </div>
                ...
                <Accordion preExpanded={"a"} className="job-accrodion">
                    ...
                    <AccordionItemHeading className="accordion-active-status">
                      <AccordionItemButton>
                        <div className="accordion-head-text">
                          <div className="name notificatio-outer">Shanu K</div>
                    ...
                    <AccordionItemPanel>
                      ...
                      <div className="accord-detals-box">
                        <div className="accordion-bottom-button Offer-release-bt-buttons">
                          <div className="more-button mapping-button">
                            EMP Mapping
                          </div>
                  ...
                  <AccordionItem uuid="b">
                    <AccordionItemHeading className="accordion-active-status">
                      <AccordionItemButton>
                        <div className="accordion-head-text">
                          <div className="name notificatio-outer">Linto</div>
                          <div className="desi joblocation">000000000</div>
                        </div>{" "}
                        <div className="col-4 acc-status-change">
                          <div class="active-status-style">0101</div>
