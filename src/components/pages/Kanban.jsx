...
const Kanban = () => {
  ...
  const [isShowingrejectpopupedit, setIsShowingrejectpopupEdit] = useState(
    false
  );
  const [isShowingreleasepopup, setIsShowingreleasepopup] = useState(false);
  const [isShowingreleasepopupedit, setIsShowingreleasepopupEdit] = useState(
    false
  );
  ...
  const loadData = async (id) => {
    ...
    const scheduleresponse = await fetch(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/getcandidates_schedule"
    );
    const rejectionresponse = await fetch(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/getcandidates_rejection"
    );
    const waitingresponse = await fetch(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/getcandidates_waiting"
    );
    const releaseresponse = await fetch(
      "http://auditportal2.bourntec.com:3001/audit_portal/public/api/getcandidates_release"
    );
    ...
    if (source.droppableId !== destination.droppableId) {
      ...
      if (destColumn.name == "Schedule") {
        ...
        const update = axios.post(
          "http://auditportal2.bourntec.com:3001/audit_portal/public/api/updatecolumn",
          values
        );
      }
    } else {
  ...
  const {
    ...
    Viewlog,
    log,
  } = EditKanbanboard(setEditstate, setIsViewLog);
  const { handleChange, values, handleSubmit, errors } = ScheduleInterviewform(
    schedule_validation,
    loadData
  );
  const {
    handleChangerejection,
    valuesrejection,
    handleSubmitrejection,
    errorsrejection,
  } = Rejectionform(rejection_validation);
  const {
    handleChangeRelease,
    valuesrelease,
    handleSubmitrelease,
    errorsrelease,
  } = Releaseform(release_validation);
          ...
          <div className="popup-head-sty candidate-tab-outer">
            <div className="popup-head-content-sty">
              <h4
                ...
                className="popup-head-h4"
              >
                Candidate Joining Details-Edit
              </h4>
            </div>
            <div className="popup-head-icon-sty">
              <MdClose
        ...
        <form onSubmit={handleSubmit_edit} className="form" noValidate>
          ...
          <div>
            ...
            <a
              ...
              onChange={edithandleChange}
              href={
                "http://localhost/audit_portal/public/uploads/resume/" +
                editvalues.edit_resume
              }
            >
              View Resume
            </a>
                            ...
                            <div class="row popup-content-height popup-row-mrg  candiate-modal-inner-tab">
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  {errorsrejection.rejectionstatus && (
                                    <p>{errorsrejection.rejectionstatus}</p>
                                  )}
                                </div>
                              </div>
                          ...
                          ([columnId, column], index) => {
                            return (
                              <div
                                ...
                                key={columnId}
                                className="candidate-boxouter drag-boxs"
                              >
                                                    ...
                                                    return (
                                                      ...
                                                      >
                                                        <div className="drag-sub-box">
                                                          ...
                                                          <div className=" in-progress-card-bx">
                                                            <div className="in-progress-name-thre-colm p-l-0">
                                                              EXP
                                                              <div>
                                                                {item.total_exp}
                                                              </div>
                                                            </div>
                                                            <div className="in-progress-name-thre-colm  ">
                                                              CTC
                                                              <div>
                                                                {item.ctc}
                                                              </div>
                                                            </div>
                                                            <div className="in-progress-name-thre-colm b-r-0 ">
                                                              EXCTC
                                                              <div>
                                                                {item.exp_ctc}
                                                              </div>
...
const KanbanColumn = ({ status, changeTaskStatus, children }) => {
  ...
  drop(ref);
  return (
    <div ref={ref} className="drag-boxs">
      {" "}
      {children}
    </div>
  );
