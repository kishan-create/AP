...
export default function Addholidaymodal({location, method}) {
  ...
  const { handleChange, values, handleSubmit, errors, post } = Calendarform(calendar_validation);
                  ...
                  <div class="col-md-4">
                    ...
                    <label for="exampleFormControlInput1">Holiday Name</label>
                     ...
                     <div class="col-md-4">
                        ...
                        <input  type="date"  name="holiday_date" onChange={handleChange} value={values.holiday_date} class="form-control" />
                        </div>
                    </div>
                   {/*  
                  <div class="col-md-4">
