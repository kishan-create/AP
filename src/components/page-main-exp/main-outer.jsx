...
<div className="top-manin-head">Recruitment</div>
</div>
<div className="main-content-area">
<div className="main-content-area-inner">
<div className="sub-head">Candidate Information 
    <div className="top-right-outer add-btn-div">
    <button type="button" className="btn  btn-maincolor btn-block"> <SiAddthis className="add-btn-icon"/> ADD</button> 
...
<div  className="main-content-section">
        ...
        <div className=" ">
            ...
            <div className="btn-group">
                <button type="button" className="btn grid-view-btn">                    
    ...
    <div className="col-md-12 card-head-bg">
      <h4 className="card-header-sty">In Progress </h4>         
      <div className="pull-right"><button className="card-header-bt-rigt">40 Items</button></div>
    </div>
    <Draggable>
    <div className="box-Draggable">
    <div className=" col-md-12">
        <article className="in-progress-card">
            <div className="in-progress-card-post">
                <button className="in-progress-card--bt-top">JAVA DEVELOPER</button>
            </div>
            <div className="in-progress-card-box-txt ">
                <div className="in-progress-name-sty">
                     Arun Kumar
                 </div>
                 <div className="in-progress-eye-icon ">
                <a href=""> <img src={eyeico}/></a>
                 </div>
            </div>
            <div className="in-progress-card-box-txt ">
                <div className="in-progress-name-sty-fullw">
            ...
            <div className="in-progress-card-box-txt b-b-0">
                <div className="in-progress-location">
                <img className="location-w-30 " src={location}/>  <span>Kakkanad</span> 
                 </div>
  ...
  <article className="card">
    ...
    <div className="col-md-12 card-head-bg">
      <h4 className="card-header-Scheduled">Scheduled </h4>         
      <div className="pull-right"><button className="card-header-bt-rigt-Schdl">40 Items</button></div>
    </div>
    <div className=" col-md-12">
        <article className="in-progress-card-Schdl">
            <div className="in-progress-card-post">
                <button className="in-progress-card--bt-top-Schdl">JAVA DEVELOPER</button>
            </div>
            <div className="in-progress-card-box-txt ">
                <div className="in-progress-name-sty">
                     Arun Kumar
  ...
  <article className="card">
    ...
    <div className="col-md-12 card-head-bg">
      <h4 className="card-header-reject">Rejection </h4>         
      <div className="pull-right"><button className="card-header-bt-rigt-reject">40 Items</button></div>
    </div>
    <div className=" col-md-12">
        <article className="in-progress-card-reject">
            <div className="in-progress-card-post">
                <button className="in-progress-card--bt-top-reject">JAVA DEVELOPER</button>
            </div>
            <div className="in-progress-card-box-txt ">
                <div className="in-progress-name-sty">
                     Arun Kumar
  ...
  <article className="card">
    ...
    <div className="col-md-12 card-head-bg">
      <h4 className="card-header-waiting">Waiting  </h4>         
      <div className="pull-right"><button className="card-header-bt-rigt-waiting">40 Items</button></div>
    </div>
    <div className=" col-md-12">
        <article className="in-progress-card-waiting">
            <div className="in-progress-card-post">
                <button className="in-progress-card--bt-top-waiting">JAVA DEVELOPER</button>
            </div>
            <div className="in-progress-card-box-txt ">
                <div className="in-progress-name-sty">
                     Arun Kumar
